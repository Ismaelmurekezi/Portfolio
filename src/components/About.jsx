...
const About = () => {
  return (
    <div className='flex justify-around items-center pt-24 bg-lightdark pb-10 '>
      <img src="/profile.png" alt="my-image" width={140} className='rounded-full '/>
      <div className=''>
        ...
        <a href="https://drive.google.com/file/d/1Eg5DXBvZHK8gja_K-2Bgosl_MwiFxEBS/view?usp=sharing" >

          <button className=" w-72 h-12 text-lg rounded-sm bg-primary mt-4 ">Downloads CV</button>
        </a>
      </div>
    </div>
  );
