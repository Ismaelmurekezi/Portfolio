...
const HeroSection = () => {
  return (
    <div className="flex flex-col md:flex-row justify-around items-center py-24">
      <div className="text-center md:text-left">
        <p className="text-xl md:text-2xl">Hi, My name is</p>
        <p className="text-primary text-3xl md:text-5xl font-semibold">
          MUREKEZI Ismael
        </p>
        <p className="w-full md:w-[800px] text-lg md:text-xl pb-7 px-4 md:px-0">
        ...
        <div className="flex justify-center md:justify-start gap-4 text-primary text-2xl md:text-4xl pt-4">
          <a
